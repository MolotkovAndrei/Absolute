...
public class CalculatorSensorsIndexTask extends CalculatorSensors {
    ...
    public void drawSensors(Canvas canvas, int index) {
        ...
        if (isDynamicsValues) {
            drawerDynamicsValues.get(0).draw(canvas, indexForDraw);
        }
        if (isDensityValues) {
    ...
    private void createPanelsForPoints(Point leftTopPointPanelForPlot,
        ...
        if (isDistributionPoints) {
            ...
            if (heightPanelForDistributionPoints > widthDistributionPanel) {
                heightPanelForDistributionPoints = widthDistributionPanel;
            }
